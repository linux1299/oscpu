...
always @(posedge clk) begin
    if(~rst_n) begin
        mstatus <= {51'b0, 13'b11_0001_0000000}; // MPP=11, MPIE=0
        mie     <= 0;
        mtvec   <= 0;
        mepc    <= 0;
        mcause  <= 0;
        ...
        case (i_cpu_csr_waddr)
            `ADDR_MSTATUS : mstatus <= {(i_cpu_csr_wdata[16:15]==2'b11 | i_cpu_csr_wdata[14:13]==2'b11), // SD
										48'b0,
                                        i_cpu_csr_wdata[14:13], //FS
										2'b11, //MPP
										3'b000,
										i_cpu_csr_wdata[7], //MPIE
										3'b0,
										i_cpu_csr_wdata[3], //MIE
										3'b0};

            `ADDR_MIE     : mie     <= {52'b0, i_cpu_csr_wdata[11], 3'b0, i_cpu_csr_wdata[7], 3'b0, i_cpu_csr_wdata[3], 3'b0};
